...
public class ShogiElephantPieceTester{
  ...
  public void testIsLegalNonCaptureMove(){
    ...
    Piece a = new ElephantPiece(test,Color.RED,"E",Shogi.Side.NORTH,null);
    
    test.addPiece(a,0,2);
    assertFalse(a.isLegalNonCaptureMove(1,3));
    assertTrue(a.isLegalNonCaptureMove(2,4));
    test.addPiece(new ElephantPiece(test,Color.RED,"E",Shogi.Side.NORTH,null),1,3);
